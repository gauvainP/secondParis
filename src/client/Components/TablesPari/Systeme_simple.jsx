...
export default class Systeme_simple extends Component {
    constructor(props) {
        super(props)
        this.state = {
...
var resultat = gainSimple+ gainIncr
        return resultat;
    ...
    render() {
        ...
        const nbParis= this.props.nbParis *2;
        ...
        return (
            <div className="home">
                ...
                <table border="1">
                    <caption>Systeme {systemeChoice}/ {nbParis /2} + Simple</caption>
                    <thead>
                        <tr>
                            <th>Vainqueur(s)</th>
                            <th>Gains</th>
